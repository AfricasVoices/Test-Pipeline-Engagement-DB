...
if __name__ == "__main__":
    ...
    parser.add_argument("google_cloud_credentials_file_path", metavar="google-cloud-credentials-file-path",
                        help="Path to a Google Cloud service account credentials file to use to access the "
                             "credentials bucket"),
    parser.add_argument("engagement_db_datasets_export_dir", metavar="engagement-db-datasets-export-dir",
    ...
    engagement_db_datasets_export_dir = args.engagement_db_datasets_export_dir
    ...
    data = get_project_messages_from_engagement_db(pipeline_config, engagement_db, engagement_db_datasets_export_dir)
