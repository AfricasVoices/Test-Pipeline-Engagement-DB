...
from src.google_form_to_engagement_db.google_form_to_engagement_db import sync_google_form_sources_to_engagement_db

log = Logger(__name__)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Syncs data from Google Forms to an engagement database")
    ...
    if pipeline_config.google_form_sources is None or len(pipeline_config.google_form_sources) == 0:
        log.info(f"No Google Form sources specified; exiting")
        exit(0)
