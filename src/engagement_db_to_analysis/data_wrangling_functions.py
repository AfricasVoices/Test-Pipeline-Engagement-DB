...
def _impute_true_missing_labels(user, participants_traced_data_map, analysis_config):
    """
...
def run_data_wrangling_functions(user, participants_traced_data_map, analysis_config):

    participants_traced_data_map = _impute_true_missing_labels(user, participants_traced_data_map, analysis_config)
