...
class CsvDatasetToEngagementDBSyncStats(SyncStats):
    def __init__(self):
        super().__init__({
            CSVSyncEvents.READ_ROW_FROM_CSV: 0,
            CSVSyncEvents.ROW_EMPTY: 0,
    ...
    def print_summary(self):
        ...
        log.info(f"Engagement db datasets in csv: {self.event_counts[ENGAGEMENT_DB_DATASETS_IN_CSV]}")
